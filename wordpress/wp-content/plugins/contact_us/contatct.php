...
//   $phpmailer->Port = 2525;
//   $phpmailer->Username = '7ae04acdebf2d7';
//   $phpmailer->Password = 'ba9df1ca73f731';
// }
...
// function myplugin_mailtrap_setup() {
//     add_action( 'phpmailer_init', 'myplugin_mailtrap_phpmailer_init' );
// }

// function myplugin_mailtrap_phpmailer_init( PHPMailer $phpmailer ) {
...
// add_action( 'init', 'myplugin_mailtrap_setup' );
